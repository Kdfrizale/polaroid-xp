...
//        Matrix matrix = ImageHelper.getOrientationMatrix(Integer.parseInt(imageProperties[TiffImageDescription.ORIENTATION]));
//
...
//    public static File getRelatedJpeg(String tiffFileName){
...
//    public static File getFilterJpeg(File tiffFile){
//        TiffBitmapFactory.Options options = new TiffBitmapFactory.Options();
//        options.inJustDecodeBounds = true;
...
//            //return baseimage
//            return getRelatedJpeg(tiffFile.getName());
//        }
//        else{
//            //return filter image if TIFF has a filter
//            return (getNumberOfLayers(tiffFile) > 1)? getFilterJpeg(tiffFile):getRelatedJpeg(tiffFile.getName());
//        }
//    }
...
//        File jpegFile = getRelatedJpeg(tiffFile.getName());
//        if(!jpegFile.exists()){
...
//
//            File filter = getFilterJpeg(tiffFile);
//            File jpegBase = getRelatedJpeg(tiffFile.getName());
//
...
//    public static class TiffImageDescription {
